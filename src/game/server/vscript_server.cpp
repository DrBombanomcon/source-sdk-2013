...
DECLARE_SCRIPT_CONST( ETFClass, TF_CLASS_SWARMER)
DECLARE_SCRIPT_CONST(ETFClass, TF_CLASS_WESTERN)
DECLARE_SCRIPT_CONST(ETFClass, TF_CLASS_GUNNER)
DECLARE_SCRIPT_CONST( ETFClass, TF_CLASS_ASSALIENT)
DECLARE_SCRIPT_CONST( ETFClass, TF_CLASS_FIREWALKER)
DECLARE_SCRIPT_CONST( ETFClass, TF_CLASS_MECHANIST)
